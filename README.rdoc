...
<strike>UAD: This plugin is still Under Active Development - do not consider it
Alpha, it is likely to be error prone and break your Redcar</strike>
...
[shift-ctrl-a]  * Jump around between M, V and C
...
[shift-ctrl-t]  * Jump around test files.
...
[shift-ctrl-y]  * Jump between unit tests and fixtures
...
* Jump from Controller#action to the most likely functional test
* Jump from view to the most likely functional test
* Jump from Model#method to the most likely unit test
* Jump from a fixture to the first usage in the unit test
* All the things I forgot to mention
* <strike>Write a decent readme.</strike>
